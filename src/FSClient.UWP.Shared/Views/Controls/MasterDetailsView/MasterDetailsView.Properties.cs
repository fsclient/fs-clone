...
namespace FSClient.UWP.Shared.Views.Controls
{
    ...
    public partial class MasterDetailsView
    {
        ...
        /// <summary>
        /// Identifies the <see cref="DetailsContainerStyle"/> dependency property.
        /// </summary>
        /// <returns>The identifier for the <see cref="DetailsContainerStyle"/> dependency property.</returns>
        public static readonly DependencyProperty DetailsContainerStyleProperty = DependencyProperty.Register(
            nameof(DetailsContainerStyle),
            typeof(Style),
            typeof(MasterDetailsView),
        ...
        /// <summary>
        /// Identifies the <see cref="DetailsTemplateSelector"/> dependency property.
        /// </summary>
        /// <returns>The identifier for the <see cref="DetailsTemplateSelector"/> dependency property.</returns>
        public static readonly DependencyProperty DetailsTemplateSelectorProperty = DependencyProperty.Register(
            nameof(DetailsTemplateSelector),
        ...
        /// </summary>
        public Style? DetailsContainerStyle
        {
            get => (Style?)GetValue(DetailsContainerStyleProperty);
            set => SetValue(DetailsContainerStyleProperty, value);
        }
