namespace FSClient.Providers
{
    ...
    public class TorLookSearchProvider : ISearchProvider
    {
        private readonly TorLookSiteProvider siteProvider;

        public TorLookSearchProvider(TorLookSiteProvider torLookSiteProvider)
        {
            siteProvider = torLookSiteProvider;
        }
        ...
        public Task<IEnumerable<ItemInfo>> FindSimilarAsync(ItemInfo original, CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(new[] {
                new ItemInfo(Site, $"tl{original.SiteId}")
                {
